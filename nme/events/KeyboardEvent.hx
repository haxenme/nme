...
class KeyboardEvent extends Event 
{
   ...
   {
      return "[KeyboardEvent type=" + type + " bubbles=" + bubbles + " cancelable=" + cancelable + " charCode=" + charCode + " keyCode=" + keyCode + " keyLocation=" + keyLocation + " ctrlKey=" + ctrlKey + " altKey=" + altKey + " shiftKey=" + shiftKey + " controlKeyValue=" + controlKey + " commandKeyValue=" + commandKey + "]";
   }
}
