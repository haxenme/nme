...
@:require(flash10) extern class Matrix3D {
	...
	@:require(flash11) function copyRawDataFrom(vector : nme.Vector<Float>, index : UInt = 0, transpose : Bool = false) : Void;
	@:require(flash11) function copyRawDataTo(vector : nme.Vector<Float>, index : UInt = 0, transpose : Bool = false) : Void;
