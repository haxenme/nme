...
class SoundChannel extends EventDispatcher {
	...
	function nmeGetLeft ():Float {
		
		return nme_sound_channel_get_left (nmeHandle);
		
	}
	
	
	function nmeGetRight ():Float {
		
		return nme_sound_channel_get_right (nmeHandle);
		
	}
	
	
	function nmeGetPosition ():Float { 
		
		return nme_sound_channel_get_position (nmeHandle);
