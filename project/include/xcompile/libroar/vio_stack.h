...
int     roar_vio_open_stack2   (struct roar_vio_calls * calls, void (*func)(void*));
...
roar_off_t   roar_vio_stack_lseek   (struct roar_vio_calls * vio, roar_off_t offset, int whence);
int     roar_vio_stack_sync    (struct roar_vio_calls * vio);
int     roar_vio_stack_ctl     (struct roar_vio_calls * vio, roar_vio_ctl_t cmd, void * data);
