...
namespace nme
{
	...
	PointRenderer::PointRenderer(const GraphicsJob &inJob, const GraphicsPath &inPath) : mData(inPath.data), mData0(inJob.mData0)
	{
	...
	void PointRenderer::SetTransform(const Transform &inTrans)
	{
		int points = mCount;
