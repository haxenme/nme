...
typedef struct Mix_Chunk {
	...
	Uint32 length_ticks; /* sample length in milliseconds */
} Mix_Chunk;
...
/* Set the playback position in milliseconds of a channel. Will
   modify the number of loops remaining by either increasing or
   decreasing based on new position.
   Returns 0 on failure, 1 on success
*/
extern DECLSPEC int SDLCALL Mix_SetChannelPosition(int which, int ms);
