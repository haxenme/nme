...
class WebGL2Context
{
   ...
   public inline function attachShader(program:GLProgram, shader:GLShader):Void
   {
      ...
      GL.nme_gl_attach_shader(program.id, shader.id);
   }

   public inline function bindAttribLocation(program:GLProgram, index:Int, name:String):Void
   {
      GL.nme_gl_bind_attrib_location(program.id, index, name);
   }

   public inline function bindBitmapDataTexture(texture:BitmapData):Void
   {
      GL.nme_gl_bind_bitmap_data_texture(texture.nmeHandle);
   }

   public inline function bindBuffer(target:Int, buffer:GLBuffer):Void
   {
      GL.nme_gl_bind_buffer(target, buffer);
   }

   public inline function bindFramebuffer(target:Int, framebuffer:GLFramebuffer):Void
   {
      GL.nme_gl_bind_framebuffer(target, framebuffer);
   }

   public inline function bindRenderbuffer(target:Int, renderbuffer:GLRenderbuffer):Void
   {
      GL.nme_gl_bind_renderbuffer(target, renderbuffer);
   }

   public inline function bindTexture(target:Int, texture:GLTexture):Void
   {
      GL.nme_gl_bind_texture(target, texture);
   }

   public inline function blendColor(red:Float, green:Float, blue:Float, alpha:Float):Void
   {
      GL.nme_gl_blend_color(red, green, blue, alpha);
   }

   public inline function blendEquation(mode:Int):Void
   {
      GL.nme_gl_blend_equation(mode);
   }

   public inline function blendEquationSeparate(modeRGB:Int, modeAlpha:Int):Void
   {
      GL.nme_gl_blend_equation_separate(modeRGB, modeAlpha);
   }

   public inline function blendFunc(sfactor:Int, dfactor:Int):Void
   {
      GL.nme_gl_blend_func(sfactor, dfactor);
   }

   public inline function blendFuncSeparate(srcRGB:Int, dstRGB:Int, srcAlpha:Int, dstAlpha:Int):Void
   {
      GL.nme_gl_blend_func_separate(srcRGB, dstRGB, srcAlpha, dstAlpha);
   }

   public inline function bufferData(target:Int, data:IMemoryRange, usage:Int):Void
   {
      GL.nme_gl_buffer_data(target, data.getByteBuffer(), data.getStart(), data.getLength(), usage);
   }

   public inline function bufferSubData(target:Int, offset:Int, data:IMemoryRange):Void
   {
      GL.nme_gl_buffer_sub_data(target, offset, data.getByteBuffer(), data.getStart(), data.getLength());
   }

   public inline function checkFramebufferStatus(target:Int):Int
   {
      return GL.nme_gl_check_framebuffer_status(target);
   }

   public inline function clear(mask:Int):Void
   {
      GL.nme_gl_clear(mask);
   }

   public inline function clearColor(red:Float, green:Float, blue:Float, alpha:Float):Void
   {
      GL.nme_gl_clear_color(red, green, blue, alpha);
   }

   public inline function clearDepth(depth:Float):Void
   {
      GL.nme_gl_clear_depth(depth);
   }

   public inline function clearStencil(s:Int):Void
   {
      GL.nme_gl_clear_stencil(s);
   }

   public inline function colorMask(red:Bool, green:Bool, blue:Bool, alpha:Bool):Void
   {
      GL.nme_gl_color_mask(red, green, blue, alpha);
   }

   public inline function compileShader(shader:GLShader):Void
   {
      GL.nme_gl_compile_shader(shader.id);
   }

   public inline function compressedTexImage2D(target:Int, level:Int, internalformat:Int, width:Int, height:Int, border:Int, data:IMemoryRange):Void
   {
      GL.nme_gl_compressed_tex_image_2d(target, level, internalformat, width, height, border, data == null ? null : data.getByteBuffer(), data == null ? null : data.getStart());
   }

   public inline function compressedTexSubImage2D(target:Int, level:Int, xoffset:Int, yoffset:Int, width:Int, height:Int, format:Int, data:IMemoryRange):Void
   {
      GL.nme_gl_compressed_tex_sub_image_2d(target, level, xoffset, yoffset, width, height, format, data == null ? null : data.getByteBuffer(), data == null ? null : data.getStart());
   }
   ...
   {
      GL.nme_gl_copy_tex_image_2d(target, level, internalformat, x, y, width, height, border);
   }
   ...
   {
      GL.nme_gl_copy_tex_sub_image_2d(target, level, xoffset, yoffset, x, y, width, height);
   }
   ...
   {
      return GL.nme_gl_get_attrib_location(program.id, name);
   }

   public inline function getBufferParameter(target:Int, pname:Int):Dynamic
   {
      return GL.nme_gl_get_buffer_paramerter(target, pname);
   }

   public inline function getContextAttributes():GLContextAttributes
   {
      var base = GL.nme_gl_get_context_attributes();
   ...
   {
      return GL.nme_gl_is_enabled(cap);
   }

   public inline function isFramebuffer(framebuffer:GLFramebuffer):Bool
   {
      return framebuffer != null && GL.nme_gl_is_framebuffer(framebuffer.id);
   }

   public inline function isProgram(program:GLProgram):Bool
   {
      return program != null && GL.nme_gl_is_program(program.id);
   }

   public inline function isRenderbuffer(renderbuffer:GLRenderbuffer):Bool
   {
      return renderbuffer != null && GL.nme_gl_is_renderbuffer(renderbuffer.id);
   }

   public inline function isShader(shader:GLShader):Bool
   {
      return shader != null && GL.nme_gl_is_shader(shader.id);
   }

   public inline function isTexture(texture:GLTexture):Bool
   {
      return texture != null && GL.nme_gl_is_texture(texture.id);
   }

   public inline function lineWidth(width:Float):Void
   {
      GL.nme_gl_line_width(width);
   }

   public inline function linkProgram(program:GLProgram):Void
   {
      GL.nme_gl_link_program(program.id);
   }

   public inline function load(inName:String, inArgCount:Int):Dynamic
   {
      try 
      {
   ...
   {
      GL.nme_gl_tex_image_2d(target, level, internalformat, width, height, border, format, type, pixels == null ? null : pixels.getByteBuffer(), pixels == null ? null : pixels.getStart());
   }

   public inline function texParameterf(target:Int, pname:Int, param:Float):Void
   {
      GL.nme_gl_tex_parameterf(target, pname, param);
   }

   public inline function texParameteri(target:Int, pname:Int, param:Int):Void
   {
      GL.nme_gl_tex_parameteri(target, pname, param);
   }
   ...
   {
      GL.nme_gl_tex_sub_image_2d(target, level, xoffset, yoffset, width, height, format, type, pixels == null ? null : pixels.getByteBuffer(), pixels == null ? null : pixels.getStart());
   }

   public inline function uniform1f(location:GLUniformLocation, x:Float):Void
   {
      GL.nme_gl_uniform1f(location, x);
   }

   public inline function uniform1fv(location:GLUniformLocation, x:NmeFloats):Void
   {
      GL.nme_gl_uniform1fv(location, x);
   }

   public inline function uniform1i(location:GLUniformLocation, x:Int):Void
   {
      GL.nme_gl_uniform1i(location, x);
   }

   public inline function uniform1iv(location:GLUniformLocation, v:NmeInts):Void
   {
      GL.nme_gl_uniform1iv(location, v);
   }

   public inline function uniform2f(location:GLUniformLocation, x:Float, y:Float):Void
   {
      GL.nme_gl_uniform2f(location, x, y);
   }

   public inline function uniform2fv(location:GLUniformLocation, v:NmeFloats):Void
   {
      GL.nme_gl_uniform2fv(location, v);
   }

   public inline function uniform2i(location:GLUniformLocation, x:Int, y:Int):Void
   {
      GL.nme_gl_uniform2i(location, x, y);
   }

   public inline function uniform2iv(location:GLUniformLocation, v:NmeInts):Void
   {
      GL.nme_gl_uniform2iv(location, v);
   }

   public inline function uniform3f(location:GLUniformLocation, x:Float, y:Float, z:Float):Void
   {
      GL.nme_gl_uniform3f(location, x, y, z);
   }

   public inline function uniform3fv(location:GLUniformLocation, v:NmeFloats):Void
   {
      GL.nme_gl_uniform3fv(location, v);
   }

   public inline function uniform3i(location:GLUniformLocation, x:Int, y:Int, z:Int):Void
   {
      GL.nme_gl_uniform3i(location, x, y, z);
   }

   public inline function uniform3iv(location:GLUniformLocation, v:NmeInts):Void
   {
      GL.nme_gl_uniform3iv(location, v);
   }

   public inline function uniform4f(location:GLUniformLocation, x:Float, y:Float, z:Float, w:Float):Void
   {
      GL.nme_gl_uniform4f(location, x, y, z, w);
   }

   public inline function uniform4fv(location:GLUniformLocation, v:NmeFloats):Void
   {
      GL.nme_gl_uniform4fv(location, v);
   }

   public inline function uniform4i(location:GLUniformLocation, x:Int, y:Int, z:Int, w:Int):Void
   {
      GL.nme_gl_uniform4i(location, x, y, z, w);
   }

   public inline function uniform4iv(location:GLUniformLocation, v:NmeInts):Void
   {
      GL.nme_gl_uniform4iv(location, v);
   }

   public inline function uniformMatrix2fv(location:GLUniformLocation, transpose:Bool, v:Float32Array):Void
   {
      GL.nme_gl_uniform_matrix(location, transpose, v.getByteBuffer(), 2);
   }

   public inline function uniformMatrix3fv(location:GLUniformLocation, transpose:Bool, v:Float32Array):Void
   {
      GL.nme_gl_uniform_matrix(location, transpose, v.getByteBuffer(), 3);
   }

   public inline function uniformMatrix4fv(location:GLUniformLocation, transpose:Bool, v:Float32Array):Void
   {
      GL.nme_gl_uniform_matrix(location, transpose, v.getByteBuffer(), 4);
   }

   public inline function uniformMatrix3D(location:GLUniformLocation, transpose:Bool, matrix:Matrix3D):Void
   {
      GL.nme_gl_uniform_matrix(location, transpose, Float32Array.fromMatrix(matrix).getByteBuffer() , 4);
   }

   public inline function useProgram(program:GLProgram):Void
   {
      GL.nme_gl_use_program(program);
   }

   public inline function validateProgram(program:GLProgram):Void
   {
      GL.nme_gl_validate_program(program.id);
   }

   public inline function vertexAttrib1f(indx:Int, x:Float):Void
   {
      GL.nme_gl_vertex_attrib1f(indx, x);
   }

   public inline function vertexAttrib1fv(indx:Int, values:NmeFloats):Void
   {
      GL.nme_gl_vertex_attrib1fv(indx, values);
   }

   public inline function vertexAttrib2f(indx:Int, x:Float, y:Float):Void
   {
      GL.nme_gl_vertex_attrib2f(indx, x, y);
   }

   public inline function vertexAttrib2fv(indx:Int, values:NmeFloats):Void
   {
      GL.nme_gl_vertex_attrib2fv(indx, values);
   }

   public inline function vertexAttrib3f(indx:Int, x:Float, y:Float, z:Float):Void
   {
      GL.nme_gl_vertex_attrib3f(indx, x, y, z);
   }

   public inline function vertexAttrib3fv(indx:Int, values:NmeFloats):Void
   {
      GL.nme_gl_vertex_attrib3fv(indx, values);
   }

   public inline function vertexAttrib4f(indx:Int, x:Float, y:Float, z:Float, w:Float):Void
   {
      GL.nme_gl_vertex_attrib4f(indx, x, y, z, w);
   }

   public inline function vertexAttrib4fv(indx:Int, values:NmeFloats):Void
   {
      GL.nme_gl_vertex_attrib4fv(indx, values);
   }

   public inline function vertexAttribPointer(indx:Int, size:Int, type:Int, normalized:Bool, stride:Int, offset:Int):Void
   {
      GL.nme_gl_vertex_attrib_pointer(indx, size, type, normalized, stride, offset);
   }

   public inline function viewport(x:Int, y:Int, width:Int, height:Int):Void
   {
      GL.nme_gl_viewport(x, y, width, height);
   }
   ...
   {
      GL.nme_gl_begin_query(target,query.id);
   }
   public inline function endQuery(target:Int):Void
   {
      GL.nme_gl_end_query(target);
   }

   public function getQueryInt(query:GLQuery, pname:Int):Int
   {
      return GL.nme_gl_query_get_int(query.id, pname);
   }
   ...
   public inline function deleteVertexArray(array:GLVertexArrayObject):Void
   {
      GL.deleteVertexArray(array);
   }
   public inline function bindVertexArray(array:GLVertexArrayObject):Void
   {
      GL.nme_gl_bind_vertex_array(array);
   }
   public inline function vertexAttribDivisor(index:Int, divisor:Int) : Void
   {
      GL.nme_gl_vertex_attrib_divisor(index, divisor);
   }
   public inline function bindBufferBase(target:Int, index:Int, buffer:GLBuffer):Void
   {
      GL.nme_gl_bind_buffer_base(target, index, buffer);
   }
   ...
   public inline function deleteTransformFeedback(feedback:GLTransformFeedback):Void
   {
      GL.nme_gl_delete_transform_feedback(feedback);
   }
   public inline function bindTransformFeedback(target:Int, feedback:GLTransformFeedback):Void
   {
      GL.nme_gl_bind_transform_feedback(target,feedback);
   }
   public inline function beginTransformFeedback(primitive:Int):Void
   {
      GL.nme_gl_begin_transform_feedback(primitive);
   }
   public inline function endTransformFeedback():Void
   {
      GL.nme_gl_end_transform_feedback();
   }
   public function transformFeedbackVaryings(prog:GLProgram, vars:Array<String>, bufferMode:Int):Void
   {
      GL.nme_gl_transform_feedback_varyings(prog, vars, bufferMode);
   }
   public function getUniformBlockIndex(prog:GLProgram, blockName:String):Int
   {
      return GL.nme_gl_get_uniform_block_index(prog, blockName);
   }
   public function uniformBlockBinding(prog:GLProgram, blockIndex:Int, blockBinding:Int):Void
   {
      GL.nme_gl_uniform_block_binding(prog, blockIndex, blockBinding);
   }
   public function blitFramebuffer( srcX0:Int, srcY0:Int, srcX1:Int, srcY1:Int, dstX0:Int, dstY0:Int, dstX1:Int, dstY1:Int, mask:Int, filter:Int)
   {
      GL.nme_gl_blit_framebuffer(srcX0, srcY0, srcX1, srcY1, dstX0, dstY0, dstX1, dstY1, mask, filter);
   }
   public function renderbufferStorageMultisample(target:Int, samples:Int, internalFormat:Int, width:Int, height:Int)
   {
      GL.nme_gl_renderbuffer_storage_multisample(target, samples, internalFormat, width, height);
   }
   public function drawBuffers(buffers:Array<Int>):Void
   {
      GL.nme_gl_draw_buffers(buffers);
   }
   public function readBuffer(buffer:Int):Void
   {
      GL.nme_gl_read_buffer(buffer);
   }

   public inline function compressedTexImage3D(target:Int, level:Int, internalformat:Int, width:Int, height:Int, depth:Int, border:Int, data:IMemoryRange, ?offset:Int, ?imagesize:Int):Void
   {
      var dataLen = 0;
      if (imagesize==null && data!=null)
          dataLen = data.getLength() - offset;
      else
         dataLen = imagesize;
      GL.compressedTexImage3D(target, level, internalformat, width, height, depth, border,dataLen,data,offset);
   }

   public inline function texImage3D(target:Int, level:Int, internalformat:Int, width:Int, height:Int, depth:Int, border:Int, format:Int, type:Int,pixels:ArrayBufferView):Void
   {
      GL.texImage3D(target, level, internalformat, width, height, depth, border, format, type, pixels);
   }
   public inline function drawArraysInstanced(mode:Int, first:Int, count:Int, instances:Int):Void
   {
      GL.nme_gl_draw_arrays_instanced(mode, first, count, instances);
   }

   public inline function drawElementsInstanced(mode:Int, count:Int, type:Int, offset:Int, instances:Int):Void
   {
      GL.nme_gl_draw_elements_instanced(mode, count, type, offset,instances);
   }
