...
class GenerateJavaExterns
{
	...
	public function new (buildTool:BuildHX, javaPath:String, externPath:String)
	{
	...
	private function extractAndroidClasses()
	{
		if (!extractedAndroidClasses)
		{
			...
			{
				buildTool.mkdir("android-7");
				buildTool.runCommand("android-7", "jar", [ "-xf", androidJAR ] );
			}
		}
	...
	public static function main()
	{
		...
		new GenerateJavaExterns(null, args[0], "gen");
	}
