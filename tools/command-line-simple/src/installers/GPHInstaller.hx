...
class GPH 
{
 ...
 // --- GPH ---------------------------------------------------------------
   function updateGph()
   {
      ...
      cp_recurse(NME + "/tools/command-line-simple/haxe",mBuildDir + "/gph/haxe");
      cp_recurse(NME + "/tools/command-line-simple/gph/hxml",mBuildDir + "/gph/haxe");
      cp_file(NME + "/tools/command-line-simple/gph/game.ini",mBuildDir + "/gph/game/"  + mDefines.get("APP_FILE") + ".ini" );
      var boot = mDebug ? "Boot-debug.gpe" : "Boot-release.gpe";
      cp_file(NME + "/tools/command-line-simple/gph/" + boot,mBuildDir + "/gph/game/"  + mDefines.get("APP_FILE") + "/Boot.gpe" );
